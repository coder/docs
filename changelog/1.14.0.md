...
description:
  "Coder v1.14.0 includes fixes to Projector, UI changes and improvements, a
  simplification of the metrics feature, and security updates. It also includes
  alpha features like container-based virtual machines (CVMs) and account
  dormancy."
---
