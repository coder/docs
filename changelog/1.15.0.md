...
- web: Deprecated **Services** in favor of a declarative approach to creating
  ...
  to be released with Coder v2.0 (ETA: Q1 of 2021). For now, services will
  continue to function as-is, though this feature will not receive any
  improvements; they will be removed with Coder v2.0
- web: The button to create an environment from an image tag has been removed
