...
- web: added hosting for the **Open in Coder SVGs** in Coder so that the
  icons render properly in firewalled networks. Coder will continue to support
  the existing external CDN for such icons, but the default will be the SVG
  hosted by Coder.
