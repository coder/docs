...
While the Environment [Image]() standardizes system dependencies for development, Coder offers a few different mechanisms
...
Data outside `/home` is provided by the Environment [Image]() and is reset between by Environment [rebuilds](./lifecycle.md). 

## ~/personalize

For cases where personal configuration of system files is needed, Environments expose the [~/personalize]() rebuild hook.
