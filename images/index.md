...
description: Learn about the basis of reproducibility inside Coder.
---

Images are the basis from which new [Environments](../environments/index.md)
are created. They are the basis of environment reproducibility.
