...
You can add registries during the process of [adding images](../../workflow/images/index.md).
...
Then, continue with the process of [adding your image](../../workflow/images/index.md). When done,
click **Import**.
