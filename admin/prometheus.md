...
| `go_sql_idle_connections`                       | `gauge`     | The number of idle database connections. |
| `go_sql_in_use_connections`                     | `gauge`     | The number of database connections currently in use. |
| `go_sql_max_idle_closed_total`                  | `counter`   | The total number of database connections closed due to too many idle connections. |
| `go_sql_max_idle_time_closed_total`             | `counter`   | The total number of database connections closed due to idling for too long. |
| `go_sql_max_lifetime_closed_total`              | `counter`   | The total number of database connections closed due to hitting maximum lifetime. |
| `go_sql_max_open_connections`                   | `gauge`     | Maximum number of open connections to the database. |
| `go_sql_open_connections`                       | `gauge`     | The number of established database connections both in use and idle. |
| `go_sql_wait_count_total`                       | `counter`   | The total number of database connections waited for. |
| `go_sql_wait_duration_seconds_total`            | `counter`   | The total time blocked waiting for a new database connection. |
